...
class lz77:
    ...
    def compress(self, file, DEBUG=False):
        ...
        try:
            ...
            print
            'Unable to write compressed file'
            exit(1)
...
'''if __name__ == '__main__':
    ...
    if arg[0] == '-h' or arg[0] == '--h' or arg[0] == '-help':
        ...
        try:
            ...
            print
            'Compression Unseccessfull.'
            exit(1)
        print
        'Compression Seccessfull.'
    elif arg[0] == '-d':
        l = lz77()
        try:
            print
            ...
            print
            'Decompression Unseccessfull'
            exit(1)
        print
        'Decompression Seccessfull'
    else:
        print
        "Invalid input"
        print
        "usage script.py [-c | -d ] filename"
        print
        "option:"
        print
        "-c\t\t\t:Compress data."
